...
export type PackageNoExtras = {
  __typename?: 'PackageNoExtras';
  categories: Array<Scalars['String']['output']>;
  date_created: Scalars['String']['output'];
  date_updated: Scalars['String']['output'];
  donation_link?: Maybe<Scalars['String']['output']>;
...
export type Query = {
  __typename?: 'Query';
  bepinex?: Maybe<Package>;
  dependencyList: DependencyQuery;
  packages: PackageQuery;
  updates: Array<PackageVersion>;
...
export type QueryVersionsArgs = {
  full_names: Array<Scalars['String']['input']>;
};
...
export type Get_PackagesQuery = { __typename?: 'Query', packages: { __typename?: 'PackageQuery', total: number, result: Array<{ __typename?: 'Package', name: string, owner: string, package_url: string, rating_score: number, full_name: string, has_nsfw_content: boolean, donation_link?: string | null, date_created: string, date_updated: string, downloads: number, categories: Array<string>, versions?: Array<{ __typename?: 'PackageVersion', icon: string, version_number: string, description: string, full_name: string, dependencies: Array<string>, website_url: string }> | null }> } };

export type Get_UpdatesQueryVariables = Exact<{
  packages?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
}>;


export type Get_UpdatesQuery = { __typename?: 'Query', updates: Array<{ __typename?: 'PackageVersion', full_name: string }> };

export type Get_Bepinex_LinkQueryVariables = Exact<{ [key: string]: never; }>;


export type Get_Bepinex_LinkQuery = { __typename?: 'Query', bepinex?: { __typename?: 'Package', full_name: string, versions?: Array<{ __typename?: 'PackageVersion', download_url: string }> | null } | null };

export type Get_VersionsQueryVariables = Exact<{
  full_names?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
}>;


export type Get_VersionsQuery = { __typename?: 'Query', versions: { __typename?: 'DependencyQuery', missing: Array<string>, packages: Array<{ __typename?: 'PackageVersion', name: string, full_name: string, dependencies: Array<string>, description: string, download_url: string, version_number: string, website_url: string, file_size: number, icon: string, package?: { __typename?: 'PackageNoExtras', donation_link?: string | null, categories: Array<string> } | null }> } };
...
export const Get_UpdatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GET_UPDATES"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"packages"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},"defaultValue":{"kind":"StringValue","value":"","block":false}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"packages"},"value":{"kind":"Variable","name":{"kind":"Name","value":"packages"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"full_name"}}]}}]}}]} as unknown as DocumentNode<Get_UpdatesQuery, Get_UpdatesQueryVariables>;
export const Get_Bepinex_LinkDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GET_BEPINEX_LINK"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bepinex"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"versions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"download_url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"full_name"}}]}}]}}]} as unknown as DocumentNode<Get_Bepinex_LinkQuery, Get_Bepinex_LinkQueryVariables>;
export const Get_VersionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GET_VERSIONS"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"full_names"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},"defaultValue":{"kind":"ListValue","values":[]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"versions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"full_names"},"value":{"kind":"Variable","name":{"kind":"Name","value":"full_names"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"packages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"full_name"}},{"kind":"Field","name":{"kind":"Name","value":"dependencies"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"download_url"}},{"kind":"Field","name":{"kind":"Name","value":"version_number"}},{"kind":"Field","name":{"kind":"Name","value":"website_url"}},{"kind":"Field","name":{"kind":"Name","value":"file_size"}},{"kind":"Field","name":{"kind":"Name","value":"icon"}},{"kind":"Field","name":{"kind":"Name","value":"package"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"donation_link"}},{"kind":"Field","name":{"kind":"Name","value":"categories"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"missing"}}]}}]}}]} as unknown as DocumentNode<Get_VersionsQuery, Get_VersionsQueryVariables>;
