...
const createWindow = async (): Promise<void> => {
	await session.defaultSession.loadExtension("C:/Users/riley/AppData/Local/Google/Chrome/User Data/Default/Extensions/jdkknkkbebbapilgoeccciglkfbmbnfm/4.8.1_0");
